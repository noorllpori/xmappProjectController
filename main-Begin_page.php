                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end pt-0">
                                <a class="dropdown-item" href="contacts-profile.html"><i class='bx bx-user-circle text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">全局设置</span></a>
                ...
                <div data-simplebar class="sidebar-menu-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="menu-title" data-key="t-pages">页面</li>
                                    ...
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-toggle arrow-none" href="index.html" id="topnav-dashboard" role="button"
                                                ...
                                                <span data-key="t-dashboards">控制面板</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                                ...
                                                <span data-key="t-apps">车辆项目</span> <div class="arrow-down"></div>
                                            </a>
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button"
                                               ...
                                               <span data-key="t-bootstrap">Demo</span> <div class="arrow-down"></div>
                                            </a>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            >
                                                ...
                                                <span data-key="t-components">组件</span> <div class="arrow-down"></div>
                                            </a>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <i class='bx bx-file'></i>
                                                <span data-key="t-pages">页面</span> <div class="arrow-down"></div>
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="topnav-more">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                                        ...
                                                        <a href="pages-comingsoon.html" class="dropdow" class="dropdownn-item" data-key="t-coming-soon">Coming Soon</a>-item" data-key="t-timeline">Timeline</a>
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                                <i class='bx bx-grid-alt'></i>
                                                <span data-key="t-apps">Blender</span> <div class="arrow-down"></div>
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="topnav-pages">

                                                <a href="apps-calendar.html" class="dropdown-item" data-key="t-calendar">直接默认启动</a>
                                                <a href="apps-calendar.html" class="dropdown-item" data-key="t-calendar">附命令行启动</a>
                                                <a href="apps-chat.html" class="dropdown-item" data-key="t-chat">无窗口命令行启动</a>
                                                <div class="dropdown">
                                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-email"
                                                        role="button">
                                                        <span data-key="t-email">3.5</span> <div class="arrow-down"></div>
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="topnav-email">
                                                        <a href="email-inbox.html" class="dropdown-item" >直接默认启动</a>
                                                        <a href="email-inbox.html" class="dropdown-item" >附命令行启动</a>
                                                        <a href="email-inbox.html" class="dropdown-item" >无窗口命令行启动</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="dropdown">
                                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-email"
                                                        role="button">
                                                        <span data-key="t-email">3.0</span> <div class="arrow-down"></div>
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="topnav-email">
                                                        <a href="email-inbox.html" class="dropdown-item" >直接默认启动</a>
                                                        <a href="email-inbox.html" class="dropdown-item" >附命令行启动</a>
                                                ...
                                                <a href="apps-calendar.html" class="dropdown-item" data-key="t-calendar">打开插件管理</a>

                                            </div>
                                        </li>
<!--
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-toggle arrow-none"  target="_blank" href='linkwindow.php?cmd=start+ulk2.bat' id="topnav-dashboard" role="button"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class='bx bx-tachometer'></i>
                                                <span data-key="t-dashboards">UnLock</span>
                                            </a>
                                        </li>
-->
                                    </ul>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end pt-0">
                                <a class="dropdown-item" href="contacts-profile.html"><i class='bx bx-user-circle text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">启动设置</span></a>
                                <a class="dropdown-item" href="apps-chat.html"><i class='bx bx-chat text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">Chat</span></a>
                                <a class="dropdown-item" href="pages-faqs.html"><i class='bx bx-buoy text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">Support</span></a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="auth-lock-screen.html"><i class='bx bx-lock text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">Lock screen</span></a>
